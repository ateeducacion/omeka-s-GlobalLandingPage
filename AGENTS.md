...
Read [global-landing](.agents/skills/global-landing/SKILL.md) when you need to: change global-home routing, landing-page configuration, navigation, or rendering.
